...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"  %>
 ...
 <body>
   ...
   <script>
       document.getElementById("info-address-btn").addEventListener("click", function() {
           new daum.Postcode({
               oncomplete: function(data) {
                   let postCode = document.getElementsByName("memberAddress")[0];
                   let basicAddrress = document.getElementsByName("memberAddress")[1];
                   let detailAddress = document.getElementsByName("memberAddress")[2];

                   postCode.value = data.zonecode;
                   basicAddrress.value = data.address;
