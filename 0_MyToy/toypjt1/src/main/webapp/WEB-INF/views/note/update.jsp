        ...
        <div class="bodywrap">
            <div class="bodycontainer"> <!-- 글씨 나오는 싸이즈(create에선 가운데 틀) -->
                <div class="bodytop">
                    ...
                    <span class="nowtm" id="nowtm">${clickNote.noteDate}</span>
                </div>
                    <!-- Note리스트 추가 되는 단 -->
                <div class="bodybottom">
                    <input type="text" id="nttitle" name="nttitle" value="${clickNote.noteTitle}" placeholder="Note Title"
                        maxlength="30" autocomplete="off">
                    <textarea type="text" id="ntmemo" name="ntmemo"  placeholder="Enter Note Text" maxlength="1000" autocomplete="off">${clickNote.noteMemo}</textarea>
                </div>
            </div>
        </div>
