package toypjt1.yun.note.common.filter;
 ...
 *   [요청흐름]
 *   클라이언트 -> 요청 
 *    -> HttpServletRequest/Response 생성 -> 필터 -> 요청처리 Servlet
 * 	
 * 	- 여러 필터를 만들어서 연쇄적으로 연결하여 수행할 수 있다. (FilterChanin)
 * 
 * @WebFilter("url 패턴")
 *  - 해당 클래스를 필터 클래스로 등록하는 역할을 함
